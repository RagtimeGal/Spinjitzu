...
## Disocrd
tellraw @a [{"translate":"chat.spin.discord","color":"aqua","clickEvent":{"action":"open_url","value":"https://discord.gg/ggEkaVrQ2t"},"hoverEvent":{"action":"show_text","contents":[{"translate":"chat.spin.discord.hover_event"}]}},"\n"]
# doReloadMessage
